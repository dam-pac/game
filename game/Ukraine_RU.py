...
exit_with_game_over_stage_2 = f'\n\n\n\n\n\n          Вы проиграли в {Back.RED}самом тупом и лёгком месте{Back.LIGHTYELLOW_EX}. Вам здесь не место!          \n                Но у вас есть маленький выбор:               \n                    1) Выйти                    \n                    2) Перезапустить                    \n'
exit_with_game_over_stage_2_input = f'  Ваш выбор (1 or 2): '
game_2_rules_1 = '\n\n          RULES: Разрешать только тому, кому больше 30 лет, в течении 10 секунд.'
game_2_rules_2 = '\n\n          RULES: Разрешать за 12 секунд только тому, у кого вес менее 65 кг, и только тому, у кого имя имеет количество букв менее 7'
game_2_rules_3 = '\n\n          RULES: Разрешать за 5 секунд только тем, кто родился в China, France, Ukraine, GB'
game_2_words_1 = 'Ты...'
game_2_words_2 = 'ТЫ!'
...
game_2_words_33 = 'соблюдать правила.'
game_2_words_34 = 'ЧТО'
...
game2_game_name = 'Имя'
game2_game_age = 'Возраст'
game2_game_countries = 'Страна'
game2_game_weight = 'Вес'
game2_game_height = 'Рост'
game2_ready = 'Если вы готовы, нажмите enter...'
game2_answer = 'Разрешить? (y/n): '
n = prog_in_text_file()
